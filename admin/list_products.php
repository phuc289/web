        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Danh mục san pham</h1>
							<button type="button" class="btn btn-success" style="margin-bottom: 20px" onClick="javascript:window.location.href='insert_product.php'">Thêm san pham</button>
                                        ...
                                        <table class="table">
                                            <thead>
                                                ...
                                                <tr>
                                                  ...
                                                  <td><a href='edit_product.php?id=<?=$row["id_product"]?>'>Sửa</a></td>
                                                  <td><a href="javascript:del_confirm('del_product.php?id=<?=$row["id_product"]?>&imagename=<?=$row['images']?>')">Xoá</a></td>
                                                </tr>
                                                <?php $i++; ?>
                                                <?php endwhile; ?>
                                                <tr>
