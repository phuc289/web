<?php
  ...
  include("session.php");
  $id=$_GET['id'];
  $resultname= $conn->query("SELECT name_brand FROM tblbrands WHERE id_brand=$id");
  if(isset($_POST['txtsubject'])){
    $txtsubject=$_POST['txtsubject'];
    $sql="UPDATE tblbrands SET name_brand='$txtsubject' WHERE id_brand=$id";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sửa nhan hieu</h1>
                    </div>
                </div>
                ...
                <form name="form" method="post" onsubmit="return a()">
                    <table class="table table-striped table-bordered table-hover" style="width:50%" align="center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Tên nhan hieu(*):</td>
                                <td><input class="form-control" name="txtsubject"  value="<?=$row['name_brand']?>"></td>
